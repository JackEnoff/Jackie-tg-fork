/datum/action/changeling/adrenaline
	...
	desc = "We shift almost all available muscle mass from the arms to our legs and heart, making us unstoppable for 20 seconds. Costs 25 chemicals."
	helptext = "Disables your arms and retracts bioweaponry, but regenerates your legs, grants you speed, makes you unable to go into soft-crit condition, and wakes you up from any stun."
...
/datum/action/changeling/adrenaline/sting_action(mob/living/carbon/user)
	...
	user.add_traits(list(TRAIT_IGNOREDAMAGESLOWDOWN, TRAIT_PARALYSIS_L_ARM, TRAIT_PARALYSIS_R_ARM, TRAIT_NOSOFTCRIT), CHANGELING_TRAIT)
...
/datum/action/changeling/adrenaline/proc/unsting_action(mob/living/user)
	...
	user.remove_traits(list(TRAIT_IGNOREDAMAGESLOWDOWN, TRAIT_PARALYSIS_L_ARM, TRAIT_PARALYSIS_R_ARM, TRAIT_NOSOFTCRIT), CHANGELING_TRAIT)
